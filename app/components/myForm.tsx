...
const MyForm = () => {
  ...
  return (
    <>
      ...
      <div id="myForm" className="w-[100vw] h-auto hidden px-4 font-[iranyekan]">
        {/* beginning of stop button and tozihat */}
            <div className='flex justify-between w-full h-auto pt-4  px-4 pb-3 border-b-2 border-purple-900 '>
